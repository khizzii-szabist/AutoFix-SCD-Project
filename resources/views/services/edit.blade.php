            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           ...
                           placeholder="e.g., Full Maintenance Package">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="url" 
                           name="image_url" 
                           value="{{ filter_var($service->image, FILTER_VALIDATE_URL) ? $service->image : '' }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition duration-150" 
                           placeholder="https://example.com/image.jpg">
                    <p class="mt-2 text-sm text-gray-500">Provide an image URL <strong>OR</strong> upload a new file below</p>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="p-2 border border-gray-200 rounded-lg inline-block">
                        @if(filter_var($service->image, FILTER_VALIDATE_URL))
                            <img src="{{ $service->image }}" alt="{{ $service->name }}" class="h-32 w-auto rounded-lg">
                        @else
                            <img src="/images/{{ $service->image }}" alt="{{ $service->name }}" class="h-32 w-auto rounded-lg">
                        @endif
                    </div>
                </div>
                @endif
